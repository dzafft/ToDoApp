  ...
  <div>
      <div class="notemaker-container">
        ...
        <div class="time-container">
          ...
          <Button class="clear-button" severity="danger" size="large" label='Clear' @click="$emit('clearNote')" />
          <Button severity="success" size="small" @click="$emit('undoEdit')" v-if="toUpdate">End Update<i class="pi pi-undo"></i></Button>
...
const emit = defineEmits(['finishUpdate', 'clearNote', 'handleButtonClick', 'update:completedByTime', 'update:completedByDate', 'update:noteTitle', 'update:noteText'])
</script>
